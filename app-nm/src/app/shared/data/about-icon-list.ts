...
export const iconList: AboutIcon[] = [
  {
    ...
    description: `Visual Studio Code is a code editor developed by Microsoft. It contains a
     plethora of useful extensions, is lightweight, and free!`
  },
  {
    title: 'Angular', class: 'angular',
    description: `Angular is a web and mobile application framework
  ...
  {
    title: 'Nodejs', class: 'node', description: `Nodejs is an open-source, cross-platform
  ...
  {
    title: 'Foundation', class: 'foundation', description: `Foundation is a front-end framework
  ...
  {
    title: 'Material Design', class: 'material-design', description: `Material is a design concept
  ...
  {
    title: 'Github', class: 'github', description: `Github is a hosting service for version control using
     Git. It's free, has tons of integrations, and is very easy to navigate and use.`
  },
  {
    title: 'Heroku', class: 'heroku', description: `Heroku is a cloud platform as a service (PaaS)
  ...
  {
    title: 'Trello', class: 'trello', description: `Trello is a web-based list-making application.
  ...
  {
    title: 'Google Analytics', class: 'google-analytics', description: `Google Analytics is a web analytics
  ...
  {
    title: 'Google Tag Manager', class: 'google-tag-manager', description: `Google Tag Manager is a tag
  ...
  {
    title: 'Photoshop', class: 'photoshop', description: `A graphic editor developed by Adobe. I use on it
  ...
  {
    title: 'Travis CI', class: 'travis', description: `Travis is a continuous integration service
  ...
  {
    title: 'HTML', class: 'html', description: `Hypertext Markup Language is the standard markup language for
  ...
  {
    title: 'TypeScript', class: 'typescript', description: `Typescript is a superset of JavaScript. Angular
  ...
  {
    title: 'JavaScript', class: 'javascript', description: `JavaScript is not quite Java. It is a high-level,
  ...
  {
    title: 'Sass', class: 'sass', description: `Sass is probably the most popular CSS extension language.
