...
export const iconList: TechIcon[] = [
  ...
  },
  {
    title: 'Foundation',
    class: 'foundation',
    description: `Foundation is a front-end framework
  ...
  },
  {
    ...
    description: `Material is a design concept
  ...
  },
  {
    title: 'Github',
    class: 'github',
    description: `Github is a hosting service for version control using
     Git. It's free, has tons of integrations, and is very easy to navigate and use.`
  },
  {
    title: 'Heroku',
    class: 'heroku',
    description: `Heroku is a cloud platform as a service (PaaS)
  ...
  },
  {
    ...
    description: `Google Tag Manager is a tag
  ...
  },
  {
    title: 'Photoshop',
    class: 'photoshop',
    description: `A graphic editor developed by Adobe. I use on it
  ...
  },
  {
    title: 'Travis CI',
    class: 'travis',
    description: `Travis is a continuous integration service
  ...
  },
  {
    title: 'TypeScript',
    class: 'typescript',
    description: `Typescript is a superset of JavaScript. Angular
  ...
  },
  {
    title: 'JavaScript',
    class: 'javascript',
    description: `JavaScript is not quite Java. It is a high-level,
  ...
  },
  {
    title: 'Sass',
    class: 'sass',
    description: `Sass is probably the most popular CSS extension language.
